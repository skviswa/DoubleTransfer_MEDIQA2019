...
class DoubleTransfer(Dataset):
    ...
    def __getitem__(self, item):
        ...
        if self.pairwise:
            batch = self.rebatch_sample(batch)
...
class DoubleTransfer_Batched(Dataset):
    ...
    def __init__(self, data_config: Dict[str, Any], mode: str =' train'):
        """
    ...
    def prepare_train_data(self):
        ...
        for dataset in self.data_config['train_datasets']:
            ...
            train_data = BatchGen(BatchGen.load(train_path, True, pairwise=pw_task, maxlen=self.data_config['max_seq_len'],
